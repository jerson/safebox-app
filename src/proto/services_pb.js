...
goog.exportSymbol('proto.LoginBiometricRequest', null, global);
 ...
 * @constructor
 */
proto.LoginBiometricRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.LoginBiometricRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.LoginBiometricRequest.displayName = 'proto.LoginBiometricRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.LoginBiometricRequest.prototype.toObject = function(
    opt_includeInstance
  ) {
    return proto.LoginBiometricRequest.toObject(opt_includeInstance, this);
  };
   ...
   *     the JSPB instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.LoginBiometricRequest} msg The msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.LoginBiometricRequest.toObject = function(includeInstance, msg) {
    var f,
      obj = {
        username: jspb.Message.getFieldWithDefault(msg, 1, ''),
        biometrickey: jspb.Message.getFieldWithDefault(msg, 2, '')
      };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.LoginBiometricRequest}
 */
proto.LoginBiometricRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.LoginBiometricRequest();
  return proto.LoginBiometricRequest.deserializeBinaryFromReader(msg, reader);
};

/**
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.LoginBiometricRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.LoginBiometricRequest}
 */
proto.LoginBiometricRequest.deserializeBinaryFromReader = function(
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @return {!Uint8Array}
 */
proto.LoginBiometricRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.LoginBiometricRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.LoginBiometricRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.LoginBiometricRequest.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.LoginBiometricRequest.prototype.getUsername = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ''));
};

/** @param {string} value */
proto.LoginBiometricRequest.prototype.setUsername = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};

/**
 * optional string biometricKey = 2;
 * @return {string}
 */
proto.LoginBiometricRequest.prototype.getBiometrickey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ''));
};

/** @param {string} value */
proto.LoginBiometricRequest.prototype.setBiometrickey = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};
